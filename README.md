...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0057FF,25:006CFF,50:0085FF,75:00A3FF,100:00C8FF&height=160&section=header&text=Vin%C3%ADcius%20Rampazzo&fontSize=55&fontColor=ffffff&animation=twinkling&fontAlignY=45&fontAlign=50&desc=Software%20Engineer%20%7C%20Full%20Stack%20%7C%20IA%20e%20RAG%20%7C%20Mobile%20%7C%20Cybersecurity&descSize=15&descAlignY=68&descColor=ffffff&descAnimation=twinkling"/>
...
<p>
  ...
  <a href="mailto:vinicius_rampazzo10@hotmail.com">
...
Gosto de trabalhar além da interface, pensando também na arquitetura, modelagem de dados, sincronização, integrações, performance, segurança e evolução do produto.

É aqui que transformo ideias em software funcional.
...
- 💻 Atuo como **Software Engineer**
- 🚀 Desenvolvimento de aplicações **Full Stack**
- 🧠 Inteligência Artificial · RAG · LLMs · Embeddings · Busca Vetorial
- 📱 React Native · Expo · Arquitetura Offline-First
- ⚡ React · Next.js · TypeScript · JavaScript
- 🐍 Python · FastAPI · APIs REST · SSE
- 🗄️ PostgreSQL · Supabase · pgvector · SQLite
- 🔄 Sincronização de dados · Pull / Push · Outbox · Reconciliation
- 🔐 Cybersecurity · Web Security · APIs Seguras
- 🌎 Portfólio: [devrampazzo.com.br](https://devrampazzo.com.br/)
- 💪 Este é o espaço onde escrevo código, estudo, construo produtos e resolvo problemas
...
<p>
  ...
  <a href="#">
      <img alt="Tailwind CSS" src="https://img.shields.io/badge/TailwindCSS-38B2AC.svg?logo=tailwind-css&logoColor=white">
  </a>
...
### 🗄️ Bancos de dados e infraestrutura
...
- 🧠 Sistemas com **Inteligência Artificial e RAG**
- 🤖 Assistentes baseados em conhecimento empresarial
- 💬 Automações inteligentes e integrações com WhatsApp
- 📱 Aplicações mobile com arquitetura **Offline-First**
- 🔄 Sistemas de sincronização entre banco local e remoto
- 🌐 Aplicações Web Full Stack
- 🏗️ Arquiteturas escaláveis e organizadas
- 🔐 Sistemas desenvolvidos com preocupação em segurança

---

## 🧠 Áreas de interesse

### 💼 Atuação **Software Engineer**
...
### 🎯 Objetivo
Construir tecnologia que resolva problemas reais.
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0050FF,20:006BFF,40:0088FF,60:00A8FF,80:00C8FF,100:66E0FF&height=160&section=footer&animation=twinkling"/>
